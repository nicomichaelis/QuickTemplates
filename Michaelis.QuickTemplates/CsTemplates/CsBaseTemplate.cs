...
namespace Michaelis.QuickTemplates.CsTemplates
{
    ...
    internal partial class CsBaseTemplate : CsBaseTemplateBase
    {
    }

    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("qtg", "0.0.0.0")]
    internal partial class CsBaseTemplateBase
    {
        public CsBaseTemplateContext Context
        {
            get
            {
                if (null == _priv_Context)
                {
                    _priv_Context = new CsBaseTemplateContext();
                }
        ...
        private CsBaseTemplateContext _priv_Context;
